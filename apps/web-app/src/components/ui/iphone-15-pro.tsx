...
export function Iphone15Pro({
  ...
  const videos = slideshowVideos ?? (videoSrc ? [videoSrc] : []);
  ...
  const videoBox = (
    ...
    >
      {videos.map((v, i) => (
        <video
          key={v}
          className="absolute inset-0 size-full object-cover transition-opacity duration-[10ms]"
          src={v}
          autoPlay
          loop
          muted
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <mask id="scr" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse">
