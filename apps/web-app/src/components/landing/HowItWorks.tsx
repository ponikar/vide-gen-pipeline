...
const NODES = [
	...
	},
	{
		...
		sub: "AI generates a hook + voiceover script for your app",
		icon: <IconPen />,
	},
	{
		label: "Generate the Video",
		sub: "Brainrot-style vertical video assembled with captions and TTS",
		icon: <IconFilm />,
	},
	{
		label: "Post to TikTok & Instagram",
		sub: "Auto-posted at the optimal time — no action needed from you",
		icon: <IconSend />,
	},
];
		...
		<section className="hiw" id="how" ref={rootRef}>
			<div className="hiw-inner">
				<div className="hiw-copy">
					...
					<p className="hiw-sub">
						While you sleep, Vid-Gen-Scale runs the full pipeline — scripts
						written, videos made, posts scheduled. Automatically.
					</p>
				</div>
						...
						{NODES.map((n, i) => (
							...
							>
								...
								{i < NODES.length - 1 && (
									<div
										className="hiw-line"
										style={{ marginLeft: n.trigger ? 27 : 23 }}
									>
