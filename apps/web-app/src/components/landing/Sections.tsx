  ...
  return (
    <div className="section" id="pricing">
      <div className="ea-box reveal">
        ...
        <p className="sub ea-sub">Vid-Gen-Scale is free to use right now. We&apos;re onboarding founders one by one. Get in early and shape what we build.</p>
        <a href="#" className="btn-fill magnetic ea-cta">Get Early Access — Free<span className="arr">→</span></a>
      </div>
    </div>
  );
}
    ...
    <div className="section" id="faq">
      <div className="faq-wrap">
        <div className="faq-head reveal">
          <div className="label" style={{ justifyContent: "center", display: "flex" }}>FAQ</div>
...
export function Footer() {
  return (
    <div className="footer">
      <div className="footer-logo"><span className="dot" />Vid-Gen-Scale</div>
      <ul className="footer-links">
        <li><a href="#">Privacy</a></li>
        <li><a href="#">Terms</a></li>
        <li><a href="#">Twitter</a></li>
      </ul>
      <div className="footer-copy">© 2026 Vid-Gen-Scale. Built for indie app developers.</div>
    </div>
  );
}
